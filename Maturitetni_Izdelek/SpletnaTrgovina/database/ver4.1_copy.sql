...
CREATE TABLE IF NOT EXISTS `WebStore`.`image` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_category_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`image_location`, `product_idItem`, `product_subCategory_name_subCategory`, `product_subCategory_category_name_category`),
...
CREATE TABLE IF NOT EXISTS `WebStore`.`product_attribute_value` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_category_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`attribute_name_attribute`),
...
CREATE TABLE IF NOT EXISTS `WebStore`.`product_check_storage` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_category_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`storage_location_name_storage_location`, `product_idItem`, `product_subCategory_name_subCategory`, `product_subCategory_category_name_category`),
...
CREATE INDEX `fk_product_to_order_product1_idx` ON `WebStore`.`product_to_order` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) VISIBLE;
...
CREATE INDEX `fk_product_to_cart_product1_idx` ON `WebStore`.`product_to_cart` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) VISIBLE;
