...
CREATE TABLE IF NOT EXISTS `subCategory` (
  ...
  INDEX `fk_subCategory_category1_idx` (`category_name_category` ASC) ,
  INDEX `fk_subCategory_subCategory1_idx` (`subCategory_name_subCategory` ASC, `subCategory_category_name_category` ASC) ,
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  INDEX `fk_product_subCategory1_idx` (`subCategory_name_subCategory` ASC, `subCategory_category_name_category` ASC) ,
...
CREATE TABLE IF NOT EXISTS `price` (
  ...
  INDEX `fk_price_product1_idx` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) ,
...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  INDEX `fk_image_product1_idx` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) ,
...
CREATE TABLE IF NOT EXISTS `product_attribute_value` (
  ...
  INDEX `fk_product_attribute_value_product1_idx` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) ,
...
CREATE TABLE IF NOT EXISTS `product_check_storage` (
  ...
  INDEX `fk_product_check_storage_product1_idx` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) ,
  INDEX `fk_product_check_storage_storage_location1_idx` (`storage_location_name_storage_location` ASC) ,
...
CREATE TABLE IF NOT EXISTS `product_discount` (
  ...
  INDEX `fk_product_discount_product1_idx` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) ,
...
CREATE TABLE IF NOT EXISTS `product_to_order` (
  ...
  `product_subCategory_category_name_category` VARCHAR(60) NOT NULL,
  `order_idorder` BIGINT UNSIGNED NOT NULL,
  INDEX `fk_order_has_product1_product1_idx` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) ,
...
CREATE TABLE IF NOT EXISTS `product_to_cart` (
  ...
  `deleted` TINYINT(1) NOT NULL DEFAULT 0,
  `delete_time` TIMESTAMP NULL,
  INDEX `fk_table1_product1_idx` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC) ,
