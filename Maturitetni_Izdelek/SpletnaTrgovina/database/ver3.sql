...
CREATE TABLE IF NOT EXISTS `WebStore`.`order` (
  ...
  INDEX `fk_order_shipping_company1_idx` (`shipping_company_name` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `WebStore`.`product_check_storage` (
  ...
  INDEX `fk_product_check_storage_storage_location1_idx` (`storage_location_name_storage_location` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `WebStore`.`transaction` (
  ...
  INDEX `fk_transaction_user_payment_card1_idx` (`user_payment_card_card_number` ASC) VISIBLE,
