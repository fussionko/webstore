...
-- -----------------------------------------------------
-- Schema webstore_ver7_7
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema webstore_ver7_7
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `webstore_ver7_7` DEFAULT CHARACTER SET utf8 COLLATE utf8_slovenian_ci ;
USE `webstore_ver7_7` ;
...
CREATE TABLE IF NOT EXISTS `product_attribute_value` (
  ...
  `name_attribute` VARCHAR(70) NOT NULL,
  `product_idItem` INT NOT NULL,
  PRIMARY KEY (`name_attribute`, `product_idItem`),
...
CREATE TABLE IF NOT EXISTS `product_discount` (
  ...
  `product_idItem` INT NOT NULL,
  PRIMARY KEY (`discount_iddiscount`, `active_start_time`, `product_idItem`),
...
CREATE TABLE IF NOT EXISTS `product_to_cart` (
  ...
  PRIMARY KEY (`create_time`, `product_idItem`),
...
CREATE TABLE IF NOT EXISTS `component_has_component_attribute` (
  `component_attributes_idcomponent_attribute` VARCHAR(70) NOT NULL,
  `value` VARCHAR(60) NOT NULL,
  `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `delete_time` TIMESTAMP NULL,
  ...
  PRIMARY KEY (`component_attributes_idcomponent_attribute`, `component_idcomponent`),
  INDEX `fk_component_has_component_attributes_component_attribute1_idx` (`component_attributes_idcomponent_attribute` ASC),
  INDEX `fk_component_has_component_attributes_component1_idx` (`component_idcomponent` ASC),
  CONSTRAINT `fk_component_has_component_attributes_component_attribute1`
    FOREIGN KEY (`component_attributes_idcomponent_attribute`)
