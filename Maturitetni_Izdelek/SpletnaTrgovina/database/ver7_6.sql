...
-- Schema WebStore
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `webstore_ver7_6` DEFAULT CHARACTER SET utf8 COLLATE utf8_slovenian_ci ;
USE `webstore_ver7_6` ;
...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  `active_stop_time` TIMESTAMP NULL,
  `product_idItem` INT NOT NULL,
  PRIMARY KEY (`image_location`, `create_time`, `product_idItem`),
