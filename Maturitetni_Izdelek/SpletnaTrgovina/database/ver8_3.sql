...
-- -----------------------------------------------------
-- Schema webstore_ver8_3
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema webstore_ver8_3
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `webstore_ver8_3` DEFAULT CHARACTER SET utf8 COLLATE utf8_slovenian_ci ;
USE `webstore_ver8_3` ;
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `addres_id_addres` BIGINT NOT NULL,
  `user_username` VARCHAR(45) NULL,
  PRIMARY KEY (`idorder`),
  INDEX `fk_order_shipping_company1_idx` (`shipping_company_name` ASC),
  INDEX `fk_order_addres1_idx` (`addres_id_addres` ASC),
  ...
  CONSTRAINT `fk_order_addres1`
    FOREIGN KEY (`addres_id_addres`)
    REFERENCES `addres` (`id_addres`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
