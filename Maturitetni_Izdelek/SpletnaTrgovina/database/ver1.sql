...
CREATE TABLE IF NOT EXISTS `WebStore`.`order_delivery_status` (
  ...
  `order_user_address_iduser_address` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idorder_delivery_status`, `order_idorder`, `order_user_address_iduser_address`),
  INDEX `fk_order_delivery_status_order1_idx` (`order_idorder` ASC, `order_user_address_iduser_address` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `WebStore`.`product_to_order` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_category_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`order_idorder`, `order_user_address_iduser_address`, `order_user_payment_card_iduser_payment`),
  INDEX `fk_order_has_product1_order1_idx` (`order_idorder` ASC, `order_user_address_iduser_address` ASC, `order_user_payment_card_iduser_payment` ASC) VISIBLE,
