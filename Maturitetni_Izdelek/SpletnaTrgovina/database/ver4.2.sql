...
CREATE TABLE IF NOT EXISTS `subCategory` (
  ...
  CONSTRAINT `fk_subCategory_subCategory1`
    ...
    REFERENCES `subCategory` (`name_subCategory` , `category_name_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_subCategory_category1_idx` ON `subCategory` (`category_name_category` ASC);

CREATE INDEX `fk_subCategory_subCategory1_idx` ON `subCategory` (`subCategory_name_subCategory` ASC, `subCategory_category_name_category` ASC);
...
CREATE INDEX `fk_product_subCategory1_idx` ON `product` (`subCategory_name_subCategory` ASC, `subCategory_category_name_category` ASC);
...
CREATE TABLE IF NOT EXISTS `price` (
  ...
  CONSTRAINT `fk_price_product1`
    ...
    REFERENCES `product` (`idItem` , `subCategory_name_subCategory` , `subCategory_category_name_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_price_product1_idx` ON `price` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC);
...
CREATE INDEX `fk_user_address_user1_idx` ON `user_address` (`user_iduser` ASC);
...
CREATE INDEX `fk_user_payment_card_user1_idx` ON `user_payment_card` (`user_iduser` ASC);
...
CREATE INDEX `fk_order_user1_idx` ON `order` (`user_iduser` ASC) ;

CREATE INDEX `fk_order_user_address1_idx` ON `order` (`user_address_iduser_address` ASC);

CREATE INDEX `fk_order_shipping_company1_idx` ON `order` (`shipping_company_name` ASC);
...
CREATE INDEX `fk_order_delivery_status_order1_idx` ON `order_delivery_status` (`order_idorder` ASC);
...
CREATE INDEX `fk_image_product1_idx` ON `image` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC);
...
CREATE INDEX `fk_product_attribute_value_product1_idx` ON `product_attribute_value` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC);
...
CREATE INDEX `fk_product_check_storage_product1_idx` ON `product_check_storage` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC);

CREATE INDEX `fk_product_check_storage_storage_location1_idx` ON `product_check_storage` (`storage_location_name_storage_location` ASC);
...
CREATE INDEX `fk_transaction_order1_idx` ON `transaction` (`order_idorder` ASC);

CREATE INDEX `fk_transaction_user_payment_card1_idx` ON `transaction` (`user_payment_card_card_number` ASC);
...
CREATE INDEX `fk_session_cart1_idx` ON `session` (`cart_idcart` ASC);

CREATE INDEX `fk_session_user1_idx` ON `session` (`user_iduser` ASC);
...
CREATE INDEX `fk_link_visited_session1_idx` ON `link_visited` (`session_idsession` ASC, `session_user_iduser` ASC);
...
CREATE INDEX `fk_product_discount_product1_idx` ON `product_discount` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC);
...
CREATE INDEX `fk_order_has_product1_product1_idx` ON `product_to_order` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC);
...
CREATE INDEX `fk_table1_product1_idx` ON `product_to_cart` (`product_idItem` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_category_name_category` ASC);

CREATE INDEX `fk_table1_cart1_idx` ON `product_to_cart` (`cart_idcart` ASC);
