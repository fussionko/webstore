...
-- Schema WebStore
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `webstore_ver7_8` DEFAULT CHARACTER SET utf8 COLLATE utf8_slovenian_ci ;
USE `webstore_ver7_8`;
...
CREATE TABLE IF NOT EXISTS `component_has_component_attribute` (
  ...
  `deleted` TINYINT(1) NOT NULL DEFAULT 0,
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`idcomponent_attribute`, `component_idcomponent`, `value`),
  INDEX `fk_component_has_component_attribute_component_attribute1_idx` (`idcomponent_attribute` ASC),
  INDEX `fk_component_has_component_attribute_component1_idx` (`component_idcomponent` ASC),
  CONSTRAINT `fk_component_has_component_attribute_component_attribute1`
    FOREIGN KEY (`idcomponent_attribute`)
    REFERENCES `component_attribute` (`idcomponent_attribute`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_component_has_component_attribute_component1`
