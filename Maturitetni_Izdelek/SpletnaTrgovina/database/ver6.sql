...
CREATE TABLE IF NOT EXISTS `subCategory` (
  ...
  `subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`name_subCategory`, `name_category`, `subCategory_name_subCategory`, `subCategory_name_category`),
  INDEX `fk_subCategory_category1_idx` (`name_category` ASC),
  INDEX `fk_subCategory_subCategory1_idx` (`subCategory_name_subCategory` ASC, `subCategory_name_category` ASC),
  ...
  CONSTRAINT `fk_subCategory_subCategory1`
    FOREIGN KEY (`subCategory_name_subCategory` , `subCategory_name_category`)
    REFERENCES `subCategory` (`name_subCategory` , `name_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`idItem`, `name_subCategory`, `name_category`, `subCategory_name_subCategory`, `subCategory_name_category`),
  INDEX `fk_product_subCategory1_idx` (`name_subCategory` ASC, `name_category` ASC, `subCategory_name_subCategory` ASC, `subCategory_name_category` ASC),
  CONSTRAINT `fk_product_subCategory1`
    FOREIGN KEY (`name_subCategory` , `name_category` , `subCategory_name_subCategory` , `subCategory_name_category`)
    REFERENCES `subCategory` (`name_subCategory` , `name_category` , `subCategory_name_subCategory` , `subCategory_name_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `price` (
  ...
  `product_name_subCategory` VARCHAR(60) NOT NULL,
  `product_name_category` VARCHAR(60) NOT NULL,
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`idprice`, `product_idItem`, `product_name_subCategory`, `product_name_category`, `product_subCategory_name_subCategory`, `product_subCategory_name_category`),
  INDEX `fk_price_product1_idx` (`product_idItem` ASC, `product_name_subCategory` ASC, `product_name_category` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_name_category` ASC),
  CONSTRAINT `fk_price_product1`
    FOREIGN KEY (`product_idItem` , `product_name_subCategory` , `product_name_category` , `product_subCategory_name_subCategory` , `product_subCategory_name_category`)
    REFERENCES `product` (`idItem` , `name_subCategory` , `name_category` , `subCategory_name_subCategory` , `subCategory_name_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`image_location`, `product_idItem`, `product_name_subCategory`, `product_name_category`, `product_subCategory_name_subCategory`, `product_subCategory_name_category`),
  INDEX `fk_image_product1_idx` (`product_idItem` ASC, `product_name_subCategory` ASC, `product_name_category` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_attribute_value` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`attribute_name_attribute`, `product_idItem`, `product_name_subCategory`, `product_name_category`, `product_subCategory_name_subCategory`, `product_subCategory_name_category`),
  INDEX `fk_product_attribute_value_product1_idx` (`product_idItem` ASC, `product_name_subCategory` ASC, `product_name_category` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_check_storage` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`storage_location_name_storage_location`, `product_idItem`, `product_name_subCategory`, `product_name_category`, `product_subCategory_name_subCategory`, `product_subCategory_name_category`),
  INDEX `fk_product_check_storage_product1_idx` (`product_idItem` ASC, `product_name_subCategory` ASC, `product_name_category` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_discount` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`discount_iddiscount`, `product_idItem`, `product_name_subCategory`, `product_name_category`, `product_subCategory_name_subCategory`, `product_subCategory_name_category`),
  INDEX `fk_product_discount_product1_idx` (`product_idItem` ASC, `product_name_subCategory` ASC, `product_name_category` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_to_order` (
  ...
  `product_subCategory_name_subCategory` VARCHAR(60) NOT NULL,
  `product_subCategory_name_category` VARCHAR(60) NOT NULL,
  PRIMARY KEY (`order_idorder`, `product_idItem`, `product_name_subCategory`, `product_name_category`, `product_subCategory_name_subCategory`, `product_subCategory_name_category`),
  INDEX `fk_product_to_order_product1_idx` (`product_idItem` ASC, `product_name_subCategory` ASC, `product_name_category` ASC, `product_subCategory_name_subCategory` ASC, `product_subCategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_to_cart` (
  ...
  PRIMARY KEY (`product_idItem`, `product_name_subCategory`, `product_name_category`, `product_subCategory_name_subCategory`, `product_subCategory_name_category`),
