...
-- -----------------------------------------------------
-- Schema webstore_ver8_9
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema webstore_ver8_9
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `webstore_ver8_9` DEFAULT CHARACTER SET utf8 COLLATE utf8_slovenian_ci ;
USE `webstore_ver8_9` ;
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `modified_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `active` TINYINT(1) NOT NULL DEFAULT 1,
  `category_name_category` VARCHAR(70) NOT NULL,
  `category_name_parent_category` VARCHAR(70) NOT NULL,
  PRIMARY KEY (`idItem`),
  INDEX `fk_product_category1_idx` (`category_name_category` ASC, `category_name_parent_category` ASC),
  CONSTRAINT `fk_product_category1`
    FOREIGN KEY (`category_name_category` , `category_name_parent_category`)
...
CREATE TABLE IF NOT EXISTS `component` (
  ...
  UNIQUE INDEX `id_product_link_UNIQUE` (`id_product_link` ASC, `id_group` ASC),
  INDEX `index3` (`id_group` ASC))
ENGINE = InnoDB;
