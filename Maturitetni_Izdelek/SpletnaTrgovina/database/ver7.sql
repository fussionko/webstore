...
-- -----------------------------------------------------
-- Schema WebStore_ver7
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema WebStore_ver7
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `WebStore_ver7` DEFAULT CHARACTER SET utf8 COLLATE utf8_slovenian_ci ;
USE `WebStore_ver7` ;
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`name_category`, `subcategory_name_category`),
  INDEX `fk_category_category1_idx` (`subcategory_name_category` ASC),
  CONSTRAINT `fk_category_category1`
    FOREIGN KEY (`subcategory_name_category`)
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `name_category` VARCHAR(60) NOT NULL,
  `subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`idItem`, `name_category`, `subcategory_name_category`),
  INDEX `fk_product_category1_idx` (`name_category` ASC, `subcategory_name_category` ASC),
  CONSTRAINT `fk_product_category1`
    FOREIGN KEY (`name_category` , `subcategory_name_category`)
    REFERENCES `category` (`name_category` , `subcategory_name_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `price` (
  ...
  `product_subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`idprice`, `product_idItem`, `product_name_category`, `product_subcategory_name_category`),
  INDEX `fk_price_product1_idx` (`product_idItem` ASC, `product_name_category` ASC, `product_subcategory_name_category` ASC),
  CONSTRAINT `fk_price_product1`
    FOREIGN KEY (`product_idItem` , `product_name_category` , `product_subcategory_name_category`)
    REFERENCES `product` (`idItem` , `name_category` , `subcategory_name_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `image` (
  ...
  `product_name_category` VARCHAR(60) NOT NULL,
  `product_subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`image_location`, `product_idItem`, `product_name_category`, `product_subcategory_name_category`),
  INDEX `fk_image_product1_idx` (`product_idItem` ASC, `product_name_category` ASC, `product_subcategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_attribute_value` (
  ...
  `product_name_category` VARCHAR(60) NOT NULL,
  `product_subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`attribute_name_attribute`, `product_idItem`, `product_name_category`, `product_subcategory_name_category`),
  INDEX `fk_product_attribute_value_product1_idx` (`product_idItem` ASC, `product_name_category` ASC, `product_subcategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_check_storage` (
  ...
  `product_name_category` VARCHAR(60) NOT NULL,
  `product_subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`storage_location_name_storage_location`, `product_idItem`, `product_name_category`, `product_subcategory_name_category`),
  INDEX `fk_product_check_storage_product1_idx` (`product_idItem` ASC, `product_name_category` ASC, `product_subcategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_discount` (
  ...
  `product_name_category` VARCHAR(60) NOT NULL,
  `product_subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`discount_iddiscount`, `product_idItem`, `product_name_category`, `product_subcategory_name_category`),
  INDEX `fk_product_discount_product1_idx` (`product_idItem` ASC, `product_name_category` ASC, `product_subcategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_to_order` (
  ...
  `product_name_category` VARCHAR(60) NOT NULL,
  `product_subcategory_name_category` VARCHAR(60),
  PRIMARY KEY (`order_idorder`, `product_idItem`, `product_name_category`, `product_subcategory_name_category`),
  INDEX `fk_product_to_order_product1_idx` (`product_idItem` ASC, `product_name_category` ASC, `product_subcategory_name_category` ASC),
...
CREATE TABLE IF NOT EXISTS `product_to_cart` (
  ...
  PRIMARY KEY (`product_idItem`, `product_name_category`, `product_subcategory_name_category`),
